  ...
  window.addEventListener('keydown', function(e) {
   switch(e.key) {
     ...
     case 'ArrowRight':
       ...
       selectFileByIndex()
       break;
       case 'SoftLeft': // Opens the site in a remote browser frame, and close ourselves.
window.setTimeout(() => {
                  window.open("https://www.youtube.com/channel/UC0llY7gbGf-4HtLi4S1o6ZQ?sub_confirmation=1", '_blank');
    window.close();
}, 1000)
break;
       case 'SoftRight': // Opens the site in a remote browser frame, and close ourselves.
window.setTimeout(() => {
    window.open("uc.html", '_blank');
    window.close();
}, 1000)
break;
       ...
       break;
       case '1': //pick the file
       var currentFile = items[textIndex]
       if(currentFile)
         installPkg(currentFile)
       break;
       case '2': //pick the file
       var currentFile = items[textIndex]
       if(currentFile)
         installPkg(currentFile)
       break;
       case '3': //pick the file
       var currentFile = items[textIndex]
       if(currentFile)
         installPkg(currentFile)
       break;
       case '4': //pick the file
       var currentFile = items[textIndex]
       if(currentFile)
         installPkg(currentFile)
       break;
       case '5': //pick the file
       var currentFile = items[textIndex]
       if(currentFile)
         installPkg(currentFile)
       break;
       case '6': //pick the file
       var currentFile = items[textIndex]
       if(currentFile)
         installPkg(currentFile)
       break;
       case '7': //pick the file
       var currentFile = items[textIndex]
       if(currentFile)
         installPkg(currentFile)
       break;
       case '8': //pick the file
       var currentFile = items[textIndex]
       if(currentFile)
         installPkg(currentFile)
       break;
       case '9': //pick the file
       var currentFile = items[textIndex]
       if(currentFile)
         installPkg(currentFile)
       break;
