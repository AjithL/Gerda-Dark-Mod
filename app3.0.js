...
function ssidnew() {
    ...
    document.getElementById("wifif").style.display = "green";
...
function passn() {
    ...
    document.getElementById("CurPass").style.display = "green";
...
function secure() {
    ...
    lock.set({'tethering.wifi.enabled': false});
    lock.set({'tethering.wifi.security.type': "wpa2-psk"});
    document.getElementById("CurPass").style.display = "red";
...
//--------------------------------------------------------------------------------
function page1() {
    document.getElementById("ssidbox").style.display = "blue";
...
function page2() {
    ...
    document.getElementById("lowbox").style.display = "blue";
    document.getElementById("lowbox2").style.display = "none";
}
function page3() {
    document.getElementById("ssidbox").style.display = "none";
    document.getElementById("lowbox").style.display = "none";
    document.getElementById("lowbox2").style.display = "blue";
}
//--------------------------------------------------------------------------------
